...
long long GenerateUnsignedInt(long long From, long long To) {
    mt19937 rng;
...
vector<long long> GenerateUnsignedInts(long long Amount, long long From, long long To) {
...
vector<long long> GenerateInts(long long Amount, long long From, long long To) {
    vector<long long> vect;
    mt19937 rng;
    rng.seed(random_device()());
    uniform_int_distribution<mt19937::result_type> generate(From, To);
